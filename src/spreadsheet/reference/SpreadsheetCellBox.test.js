...
test("create missing x fails", () => {
    const x = null;
    expect(() => new SpreadsheetCellBox(reference(), x, y(), width(), height())).toThrow("Missing x");
});
...
test("create invalid x value fails", () => {
    const x = -1;
    expect(() => new SpreadsheetCellBox(reference(), x, y(), width(), height())).toThrow("Expected number x >= 0 got " + x);
});
...
test("create missing y fails", () => {
    const y = null;
    expect(() => new SpreadsheetCellBox(reference(), x(), y, width(), height())).toThrow("Missing y");
});
...
test("create invalid y value fails", () => {
    const y = -1;
    expect(() => new SpreadsheetCellBox(reference(), x(), y, width(), height())).toThrow("Expected number y >= 0 got " + y);
});
...
test("create missing width fails", () => {
    const width = null;
    expect(() => new SpreadsheetCellBox(reference(), x(), y(), width, height())).toThrow("Missing width");
});
...
test("create invalid width value fails", () => {
    const width = -1;
    expect(() => new SpreadsheetCellBox(reference(), x(), y(), width, height())).toThrow("Expected number width >= 0 got " + width);
});
...
test("create missing height fails", () => {
    const height = null;
    expect(() => new SpreadsheetCellBox(reference(), x(), y(), width(), height)).toThrow("Missing height");
});
...
test("create invalid height value fails", () => {
    const height = -1;
    expect(() => new SpreadsheetCellBox(reference(), x(), y(), width(), height)).toThrow("Expected number height >= 0 got " + height);
});
